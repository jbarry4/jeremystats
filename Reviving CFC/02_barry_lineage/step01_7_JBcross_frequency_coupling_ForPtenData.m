function []=step01_7_JBcross_frequency_coupling_ForPtenData ()
...
path_xls='C:\Users\Z390\Desktop';
path_out='C:\Users\Z390\Desktop\PTEN_CFCs\Test\';

%You could delet the "global" above and just put the path to an excel file
%that has the information below for your experiment and subject parameters.

cd (path_xls);
[data,txt] =  xlsread('EEGData_FeederSheetTemplate_May10.xlsx');
qqq=txt(1:2,:);
txt(1:2,:)=[];
...
AmpFreqVector=20:5:300;% with 20 y is 25 increments of 5:; Normally 200 but opening up to 300 to look for pHFO coupling in PTEN kos
...
cd (path_out);
    new_name = ['Comodulogram','_',SessID1,'_',Cond,'_',Layer,'_',num2str(eegnum)];
    new_name2 = ['ComodFig','_',SessID1,'_',Cond,'_',Layer,'_',num2str(eegnum)]; 
