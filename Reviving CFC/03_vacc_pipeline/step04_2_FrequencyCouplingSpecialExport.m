function []=step04_2_FrequencyCouplingSpecialExport ()
...
files = dir(fullfile(path_xls,'*Feeder.xlsx'));
...
cd (newcd)
    new_name = [ratId, ' Comodulogram','_',num2str(eegnum)];
    new_name2 = [ratId,' ComodFig','_',num2str(eegnum)]; 
