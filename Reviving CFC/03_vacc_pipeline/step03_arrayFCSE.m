function step03_arrayFCSE(arrayIdx)
...
addpath(fullfile(workdir, 'VACCQuickstart'));
...
feeders = readlines('feeder_sheets.csv', 'EmptyLineRule', 'skip');
...
for ii = 1:64
    ...
    step04_newFCSE(workdir, ratId, eegnum, session, eegpath, group, region, ncs_file);
end
