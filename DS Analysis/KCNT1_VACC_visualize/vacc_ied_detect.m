function vacc_ied_detect(basePath, fiftyNineBad)
...
% Aligned with new file specifications. Steps into subfolders, handles
% file typos/gaps, pads with NaNs, and dynamically drops bad channels.
...
fprintf('\n[INFO] Starting vacc_ied_detect (v4 Nested Fuzzy-Match)\n');
...
isCSC59 = (foundChannels == 59); % <--- Added for Channel 59
...
output_ets_file = fullfile(basePath, 'ets_hippocampus_59rm.mat');
output_ech_file = fullfile(basePath, 'ech_hippocampus_59rm.mat');
